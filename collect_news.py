...
# واحد يُسقط المخرج كله (سقط Cloudflare دائماً وSupabase مؤقتاً).
# ٥/٩/٢٠٢٦ — رُفع إلى المسح الكامل بعد مسبار على هذا المخرج نفسه (ورك فلو
# مؤقت للقراءة فقط، أُزيل بعد التقييم): مسحان كاملان لزوايا جوجل الـ٢١
# بينهما هدنة دقيقة ⇒ ١٩/٢١ ناجحة فى الاثنين · **صفر محجوبة** · ١٨٫٩ ث
# و١٦٫٨ ث · وأربع عشرة زاوية بلغت سقف الأربعين عنصراً. (الفاشلتان مجموعتا
# فيسبوك بموجز فارغ من جوجل، لا حظر.)
# الحمل عند جولتين بالساعة: ٢١ × ٤٨ = ~١٠٠٨ طلب/يوم، أى ثلث الحدّ الخطر.
# المكسب ليس التوفير بل اكتمال الصورة: لقطة متّسقة فى جولة واحدة بدل رُبع
# صورة تتجمّع على ثلاث جولات، وتسقط معها مماحكة المؤشّر الدوّار.
